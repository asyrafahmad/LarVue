...
export default {
    ...
    methods:{
        allExpense(){                                                                          // to display all the employees data from db into table
        ...
        deleteExpense(id){
            Swal.fire({
                ...
                if(result.value){
                    ...
                    axios.delete('/api/expense/'+id)                                           // to delete selected employee based on id
                    .then(() => {
                        this.expenses = this.expenses.filter(expense => {
                            return expense.id != id                                            // ** NOT EQUALLY same with the past id 
                        })
                    })
                    .catch(() => {
                        this.$router.push({name: 'expense'})                                   // return back to employee list table
                    })
