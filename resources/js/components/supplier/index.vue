...
export default {
    ...
    methods:{
        allSupplier(){                                                                          // to display all the employees data from db into table
        ...
        deleteSupplier(id){
            Swal.fire({
                ...
                if(result.value){
                    ...
                    axios.delete('/api/supplier/'+id)                                           // to delete selected employee based on id
                    .then(() => {
                        this.suppliers = this.suppliers.filter(supplier => {
                            return supplier.id != id                                            // ** NOT EQUALLY same with the past id 
                        })
                    })
                    .catch(() => {
                        this.$router.push({name: 'supplier'})                                   // return back to employee list table
                    })
