...
export default {
    ...
    methods:{
        allCategory(){                                                                          // to display all the employees data from db into table
        ...
        deleteCategory(id){
            Swal.fire({
                ...
                if(result.value){
                    ...
                    axios.delete('/api/category/'+id)                                           // to delete selected employee based on id
                    .then(() => {
                        this.categories = this.categories.filter(category => {
                            return category.id != id                                            // ** NOT EQUALLY same with the past id 
                        })
                    })
                    .catch(() => {
                        this.$router.push({name: 'category'})                                   // return back to employee list table
                    })
