                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Stock" v-model="form.product_quantity">
...
export default {
    ...
    methods:{
        ...
        stockUpdate(){
            ...
            .then(() => {
                this.$router.push({ name: 'stock'})                      // direct to all employee page
